...
const userData = {
  ...
  courses: [
    { id: 1, title: "Python for Beginners", progress: 70, color: "blue" },
    { id: 2, title: "Modern JavaScript", progress: 45, color: "yellow" },
    { id: 3, title: "Advanced React Hooks", progress: 10, color: "purple" },
  ],
  streak: 15,
  xp: 1250,
  badges: 3,
...
const navLinks = [
  ...
  { name: 'Courses', icon: BookOpenText, path: '#courses' },
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans">
      ...
      <main className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        {/* Welcome Message */}
        <div className="mb-10 p-6 bg-white rounded-xl shadow-lg border-l-4 border-indigo-500">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-gradient-to-r from-indigo-500 to-purple-600 p-8 rounded-xl shadow-xl text-white">
              ...
              <h3 className="text-2xl font-bold mb-4">
                Continue Lesson 5: Loops and Iteration
              </h3>
              <button className="flex items-center space-x-2 bg-white text-indigo-600 px-6 py-2 rounded-full font-semibold shadow-lg hover:bg-indigo-50 transition duration-150">
...
const StatCard = ({ value, label, icon: Icon, color }) => (
  <div className={`p-4 rounded-lg border border-${color}-200 bg-${color}-50`}>
...
const ActionCard = ({ title, description, icon: Icon, color }) => (
  <div className={`flex items-center p-4 border rounded-xl hover:shadow-md transition duration-150 border-${color}-300`}>
